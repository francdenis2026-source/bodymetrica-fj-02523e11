      ...
      <div className="relative z-10 p-5 flex items-start gap-4">
          ...
          {action && (
            <div className="pt-3">
              <button
                ...
                className={cn(
                  "px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95",
        ...
        {onClose && (
          <button 
            ...
            className="shrink-0 p-1 hover:bg-white/5 rounded-full text-foreground/40 hover:text-foreground transition-colors"
          >
            <X size={16} />
          </button>
        )}
