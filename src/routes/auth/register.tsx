...
function RegisterPage() {
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-background text-foreground">
      <img
        src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&q=88&w=2200"
        alt=""
        aria-hidden="true"
        className="absolute inset-0 h-full w-full object-cover object-center"
      />
      <div className="absolute inset-0 bg-background/54 dark:bg-background/64" />
      <div className="absolute inset-0 bg-gradient-to-r from-background/92 via-background/66 to-background/34 dark:from-background/95 dark:via-background/76 dark:to-background/48" />
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] max-w-7xl items-center px-4 py-6 md:px-6 lg:py-8">
        <div className="grid w-full items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] xl:gap-16">
          ...
          >
            <Link
              to="/"
              className="mb-12 inline-flex min-h-11 items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-background/76 px-3 py-1.5 text-sm font-medium shadow-sm backdrop-blur-md">
              <Sparkles size={15} className="text-primary" aria-hidden="true" />
              Seu acompanhamento começa aqui
            </div>

            <h1 className="mt-5 max-w-xl font-display text-[clamp(3rem,5vw,4.8rem)] font-semibold leading-[0.98] tracking-[-0.045em] text-balance">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
              {[
                ...
                <div
                  key={number}
                  className="rounded-2xl border border-border/75 bg-background/74 p-4 shadow-sm backdrop-blur-md"
                >
          ...
          >
            <div className="rounded-[2rem] border border-border/85 bg-background/95 p-5 shadow-2xl shadow-black/10 backdrop-blur-xl sm:p-7 md:p-8">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="mt-7 space-y-5" noValidate>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input
                              ...
                              className="h-12 rounded-xl border-border/85 bg-background pl-11 text-base shadow-sm focus-visible:ring-2 focus-visible:ring-primary"
                              {...field}
                            />
                          </div>
                        </FormControl>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className="h-12 rounded-xl border-border/85 bg-background pl-11 pr-11 text-base shadow-sm focus-visible:ring-2 focus-visible:ring-primary"
                                {...field}
                              />
                              <button
                                type="button"
                                onClick={() => setShowPassword((value) => !value)}
                                className="absolute right-2 top-1/2 flex size-9 -translate-y-1/2 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                className="h-12 rounded-xl border-border/85 bg-background pr-11 text-base shadow-sm focus-visible:ring-2 focus-visible:ring-primary"
                                {...field}
                              />
                              <button
                                type="button"
                  ...
                  <div className="grid gap-2 rounded-2xl border border-border/75 bg-muted/20 p-4 sm:grid-cols-3">
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="group h-12 w-full rounded-xl text-base font-medium shadow-md transition-[transform,box-shadow] duration-150 hover:shadow-lg active:scale-[0.98] motion-reduce:transition-none"
                  >
                    {isLoading ? "Criando sua conta..." : "Criar conta e continuar"}
                    {!isLoading && (
                      <ArrowRight
                        size={17}
                        className="ml-2 transition-transform duration-150 group-hover:translate-x-0.5 motion-reduce:transition-none"
                      />
                    )}
                  </Button>
